...
import { F as Sparkles, N as Bell, S as CreditCard, a as User, f as Phone, j as CalendarClock, s as Trash2 } from "../_libs/lucide-react.mjs";
...
import { t as Route } from "./settings-DuNx9TIS.mjs";
import { n as SwitchThumb, t as Switch$1 } from "../_libs/radix-ui__react-switch.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/settings-Dq8XSa2E.js
...
function BillingCard({ plan, billingDate }) {
	...
	async function openPortal() {
		setLoading(true);
		try {
			const { createPortalSession } = await import("./payments.functions-RAkfS-Pz.mjs").then((n) => n.n);
