//#region node_modules/.nitro/vite/services/ssr/assets/_tanstack-start-manifest_v-BrOB3_MF.js
var tsrStartManifest = () => ({ routes: {
	__root__: {
		...
		scripts: [{ attrs: {
			type: "module",
			async: !0,
			src: "/assets/index-B9DwHOdI.js"
		} }]
	},
	"/": {
		filePath: "/workspaces/LeadCatch/src/routes/index.tsx",
		children: void 0,
		preloads: [
	...
	"/_authenticated": {
		filePath: "/workspaces/LeadCatch/src/routes/_authenticated/route.tsx",
		children: [
	...
	"/_authenticated/appointments": {
		filePath: "/workspaces/LeadCatch/src/routes/_authenticated/appointments.tsx",
		children: void 0,
		preloads: [
