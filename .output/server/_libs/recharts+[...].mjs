...
import { C as require_get, E as require_isObject, S as require_sortBy, T as require_isFunction, _ as require_uniqBy, a as require_find, b as require_isString, c as require_isBoolean, d as require_flatMap, f as require_min, g as require_throttle, h as require_isEqual, i as require_range, l as require_isPlainObject, m as require_upperFirst, n as require_maxBy, o as require_every, p as require_max, r as require_some, s as require_mapValues, t as require_minBy, u as require_last, v as require_isNaN, w as require_memoize, x as require_isNil, y as require_isNumber } from "./lodash.mjs";
...
var DefaultTooltipContent = function DefaultTooltipContent(props) {
	...
	var renderContent = function renderContent() {
		if (payload && payload.length) {
			...
			var items = (itemSorter ? (0, import_sortBy.default)(payload, itemSorter) : payload).map(function(entry, i) {
				...
				var finalItemStyle = _objectSpread$35({
					display: "block",
					paddingTop: 4,
					paddingBottom: 4,
	...
	var finalStyle = _objectSpread$35({
		margin: 0,
		padding: 10,
		backgroundColor: "#fff",
	...
	var finalLabelStyle = _objectSpread$35({ margin: 0 }, labelStyle);
	...
	return /*#__PURE__*/ import_react.createElement("div", _extends$30({
		className: wrapperCN,
		style: finalStyle
	...
	return _createClass$20(TooltipBoundingBox, [
		...
		},
		{
			...
			value: function render() {
				...
				var outerStyle = _objectSpread$34(_objectSpread$34({ transition: isAnimationActive && active ? "transform ".concat(animationDuration, "ms ").concat(animationEasing) : void 0 }, cssProperties), {}, {
					pointerEvents: "none",
	...
	return _createClass$19(Tooltip, [{
		...
		value: function render() {
			...
			return /*#__PURE__*/ import_react.createElement(TooltipBoundingBox, {
				...
				viewBox,
				wrapperStyle
			}, renderContent$1(content, _objectSpread$33(_objectSpread$33({}, this.props), {}, { payload: finalPayload })));
		}
	}]);
}(import_react.PureComponent);
...
var getPath$1 = function getPath(_ref) {
	...
	if (Array.isArray(baseLine)) {
		...
		var areaPoints = formatPoints.map(function(entry, index) {
			return _objectSpread$31(_objectSpread$31({}, entry), {}, { base: formatBaseLine[index] });
		});
...
var Curve = function Curve(props) {
	...
	return /*#__PURE__*/ import_react.createElement("path", _extends$28({}, filterProps(props, false), adaptEventHandlers(props), {
...
_defineProperty$33(ErrorBar, "defaultProps", {
	stroke: "black",
	strokeWidth: 1.5,
	width: 5,
	offset: 0,
...
_defineProperty$33(ErrorBar, "displayName", "ErrorBar");
//#endregion
...
var Symbols = function Symbols(_ref) {
	...
	var props = _objectSpread$29(_objectSpread$29({}, _objectWithoutProperties$13(_ref, _excluded$13)), {}, {
		type,
		size,
		sizeType
	});
	...
	return _createClass$16(DefaultLegendContent, [
		{
			...
			value: function renderIcon(data) {
				...
				if (/*#__PURE__*/ import_react.isValidElement(data.legendIcon)) {
					var iconProps = _objectSpread$28({}, data);
		...
		},
		{
			...
			value: function renderItems() {
				...
				return payload.map(function(entry, i) {
					...
					var className = clsx(_defineProperty$31(_defineProperty$31({ "recharts-legend-item": true }, "legend-item-".concat(i), true), "inactive", entry.inactive));
					if (entry.type === "none") return null;
...
_defineProperty$31(DefaultLegendContent, "displayName", "Legend");
_defineProperty$31(DefaultLegendContent, "defaultProps", {
	iconSize: 14,
	layout: "horizontal",
	align: "center",
	verticalAlign: "middle",
...
var Legend = /*#__PURE__*/ function(_PureComponent) {
	function Legend() {
		...
		_defineProperty$30(_this, "lastBoundingBox", {
			width: -1,
			height: -1
		});
		return _this;
	...
	return _createClass$15(Legend, [
		...
		},
		{
			...
			value: function getBBoxSnapshot() {
				if (this.lastBoundingBox.width >= 0 && this.lastBoundingBox.height >= 0) return _objectSpread$27({}, this.lastBoundingBox);
				return {
					width: 0,
					height: 0
				};
		...
		},
		{
			...
			value: function getDefaultPosition(style) {
				...
				return _objectSpread$27(_objectSpread$27({}, hPos), vPos);
			}
		},
		{
			key: "render",
			value: function render() {
				...
				var outerStyle = _objectSpread$27(_objectSpread$27({
					position: "absolute",
					width: width || "auto",
					height: height || "auto"
				...
				}, renderContent(content, _objectSpread$27(_objectSpread$27({}, this.props), {}, { payload: getUniqPayload(payload, payloadUniqBy, defaultUniqBy) })));
			}
		}
	], [{
		key: "getWithHeight",
		value: function getWithHeight(item, chartWidth) {
			var layout = _objectSpread$27(_objectSpread$27({}, this.defaultProps), item.props).layout;
...
_defineProperty$30(Legend, "displayName", "Legend");
_defineProperty$30(Legend, "defaultProps", {
	iconSize: 14,
	layout: "horizontal",
	align: "center",
...
var formatAxisMap$1 = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
	...
	return Object.keys(axisMap).reduce(function(result, id) {
		...
		var ticks = getTicksOfScale(scale, _objectSpread$24(_objectSpread$24({}, axis), {}, { realScaleType }));
		var finalAxis = _objectSpread$24(_objectSpread$24(_objectSpread$24({}, axis), ticks), {}, {
			range,
			radius: outerRadius,
			realScaleType,
			scale,
		...
		return _objectSpread$24(_objectSpread$24({}, result), {}, _defineProperty$27({}, id, finalAxis));
	}, {});
};
...
var Rectangle = function Rectangle(rectangleProps) {
	var props = _objectSpread$21(_objectSpread$21({}, defaultProps$3), rectangleProps);
...
var Trapezoid = function Trapezoid(props) {
	var trapezoidProps = _objectSpread$20(_objectSpread$20({}, defaultProps$2), props);
	var pathRef = (0, import_react.useRef)();
	...
	if (!isUpdateAnimationActive) return /*#__PURE__*/ import_react.createElement("g", null, /*#__PURE__*/ import_react.createElement("path", _extends$19({}, filterProps(trapezoidProps, true), {
		className: layerClass,
	...
	return /*#__PURE__*/ import_react.createElement(es6_default, {
		...
		return /*#__PURE__*/ import_react.createElement(es6_default, {
			...
			duration: animationDuration,
			easing: animationEasing
		}, /*#__PURE__*/ import_react.createElement("path", _extends$19({}, filterProps(trapezoidProps, true), {
			className: layerClass,
...
var Sector = function Sector(sectorProps) {
	var props = _objectSpread$19(_objectSpread$19({}, defaultProps$1), sectorProps);
...
function defaultPropTransformer(option, props) {
	return _objectSpread$18(_objectSpread$18({}, props), option);
}
...
function Shape(_ref2) {
	...
	var shape;
	if (/*#__PURE__*/ (0, import_react.isValidElement)(option)) shape = /*#__PURE__*/ (0, import_react.cloneElement)(option, _objectSpread$18(_objectSpread$18({}, props), getPropsFromShapeOption(option)));
...
var Pie = /*#__PURE__*/ function(_PureComponent) {
	function Pie(props) {
		...
		_defineProperty$20(_this, "pieRef", null);
		_defineProperty$20(_this, "sectorRefs", []);
		_defineProperty$20(_this, "id", uniqueId("recharts-pie-"));
		_defineProperty$20(_this, "handleAnimationEnd", function() {
			var onAnimationEnd = _this.props.onAnimationEnd;
			_this.setState({ isAnimationFinished: true });
			if ((0, import_isFunction.default)(onAnimationEnd)) onAnimationEnd();
		});
		_defineProperty$20(_this, "handleAnimationStart", function() {
	...
	return _createClass$14(Pie, [
		...
		},
		{
			...
			value: function renderLabels(sectors) {
				...
				var labels = sectors.map(function(entry, i) {
					...
					var labelProps = _objectSpread$17(_objectSpread$17(_objectSpread$17(_objectSpread$17({}, pieProps), entry), {}, { stroke: "none" }, customLabelProps), {}, {
						index: i,
						textAnchor: Pie.getTextAnchor(endPoint.x, entry.cx)
					}, endPoint);
					var lineProps = _objectSpread$17(_objectSpread$17(_objectSpread$17(_objectSpread$17({}, pieProps), entry), {}, {
						fill: "none",
						stroke: entry.fill
		...
		},
		{
			...
			value: function renderSectorsStatically(sectors) {
				...
				return sectors.map(function(entry, i) {
					...
					var sectorProps = _objectSpread$17(_objectSpread$17({}, entry), {}, {
					...
					}, adaptEventsOfChild(_this2.props, entry, i), { key: "sector-".concat(entry === null || entry === void 0 ? void 0 : entry.startAngle, "-").concat(entry === null || entry === void 0 ? void 0 : entry.endAngle, "-").concat(entry.midAngle, "-").concat(i) }), /*#__PURE__*/ import_react.createElement(Shape, _extends$17({
				...
				return /*#__PURE__*/ import_react.createElement(es6_default, {
					...
					sectors.forEach(function(entry, index) {
						...
						if (prev) {
							...
							var latest = _objectSpread$17(_objectSpread$17({}, entry), {}, {
							...
							var _latest = _objectSpread$17(_objectSpread$17({}, entry), {}, {
								startAngle: curAngle + paddingAngle,
		...
		},
		{
			...
			value: function renderLabelLineItem(option, props, key) {
				...
				return /*#__PURE__*/ import_react.createElement(Curve, _extends$17({}, props, {
					key,
					type: "linear",
					className
				}));
		...
		},
		{
			...
			value: function renderLabelItem(option, props, value) {
				...
				return /*#__PURE__*/ import_react.createElement(Text, _extends$17({}, props, {
...
_Pie = Pie;
_defineProperty$20(Pie, "displayName", "Pie");
_defineProperty$20(Pie, "defaultProps", {
	stroke: "#fff",
	fill: "#808080",
	legendType: "rect",
	cx: "50%",
...
_defineProperty$20(Pie, "parseDeltaAngle", function(startAngle, endAngle) {
	return mathSign(endAngle - startAngle) * Math.min(Math.abs(endAngle - startAngle), 360);
});
_defineProperty$20(Pie, "getRealPieData", function(itemProps) {
	...
	if (data && data.length) return data.map(function(entry, index) {
		return _objectSpread$17(_objectSpread$17(_objectSpread$17({ payload: entry }, presentationProps), entry), cells && cells[index] && cells[index].props);
	});
	if (cells && cells.length) return cells.map(function(cell) {
		return _objectSpread$17(_objectSpread$17({}, presentationProps), cell.props);
	});
	return [];
});
_defineProperty$20(Pie, "parseCoordinateOfPie", function(itemProps, offset) {
...
_defineProperty$20(Pie, "getComposedData", function(_ref4) {
	var item = _ref4.item, offset = _ref4.offset;
	var itemProps = item.type.defaultProps !== void 0 ? _objectSpread$17(_objectSpread$17({}, item.type.defaultProps), item.props) : item.props;
	...
	if (sum > 0) {
		...
		sectors = pieData.map(function(entry, i) {
			...
			prev = _objectSpread$17(_objectSpread$17(_objectSpread$17({
				percent,
				cornerRadius,
				name,
				tooltipPayload: [{
	...
	return _objectSpread$17(_objectSpread$17({}, coordinate), {}, {
		sectors,
		data: pieData
	});
});
...
function typeguardBarRectangleProps(_ref, props) {
	var xProp = _ref.x, yProp = _ref.y, option = _objectWithoutProperties$8(_ref, _excluded$8);
	...
	return _objectSpread$16(_objectSpread$16(_objectSpread$16(_objectSpread$16(_objectSpread$16({}, props), option), x ? { x } : {}), y ? { y } : {}), {}, {
		height,
		width,
		name: props.name,
		radius: props.radius
...
function BarRectangle(props) {
	return /*#__PURE__*/ import_react.createElement(Shape, _extends$16({
		shapeType: "rectangle",
...
var Bar = /*#__PURE__*/ function(_PureComponent) {
	function Bar() {
		...
		_defineProperty$18(_this, "state", { isAnimationFinished: false });
		_defineProperty$18(_this, "id", uniqueId("recharts-bar-"));
	...
	return _createClass$13(Bar, [
		{
			...
			value: function renderRectanglesStatically(data) {
				...
				return data && data.map(function(entry, i) {
					...
					var props = _objectSpread$15(_objectSpread$15(_objectSpread$15({}, baseProps), entry), {}, {
						isActive,
						option,
						index: i,
						dataKey,
			...
			value: function renderRectanglesWithAnimation() {
				...
				return /*#__PURE__*/ import_react.createElement(es6_default, {
					...
					var stepData = data.map(function(entry, index) {
						...
						return _objectSpread$15(_objectSpread$15({}, entry), {}, { width: w });
					});
		...
		},
		{
			...
			value: function renderBackground() {
				...
				return data.map(function(entry, i) {
					...
					var props = _objectSpread$15(_objectSpread$15(_objectSpread$15(_objectSpread$15(_objectSpread$15({}, rest), {}, { fill: "#eee" }, background), backgroundProps), adaptEventsOfChild(_this4.props, entry, i)), {}, {
					...
					return /*#__PURE__*/ import_react.createElement(BarRectangle, _extends$15({
...
_Bar = Bar;
_defineProperty$18(Bar, "displayName", "Bar");
_defineProperty$18(Bar, "defaultProps", {
	xAxisId: 0,
	yAxisId: 0,
	legendType: "rect",
	minPointSize: 0,
...
*/
_defineProperty$18(Bar, "getComposedData", function(_ref2) {
	var props = _ref2.props, item = _ref2.item, barPosition = _ref2.barPosition, bandSize = _ref2.bandSize, xAxis = _ref2.xAxis, yAxis = _ref2.yAxis, xAxisTicks = _ref2.xAxisTicks, yAxisTicks = _ref2.yAxisTicks, stackedData = _ref2.stackedData, dataStartIndex = _ref2.dataStartIndex, displayedData = _ref2.displayedData, offset = _ref2.offset;
	var pos = findPositionOfBar(barPosition, item);
	if (!pos) return null;
	var layout = props.layout;
	var itemDefaultProps = item.type.defaultProps;
	var itemProps = itemDefaultProps !== void 0 ? _objectSpread$15(_objectSpread$15({}, itemDefaultProps), item.props) : item.props;
	...
	return _objectSpread$15({
		data: displayedData.map(function(entry, index) {
			...
			return _objectSpread$15(_objectSpread$15(_objectSpread$15({}, entry), {}, {
				x,
				y,
				width,
				height,
...
var formatAxisMap = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
	...
	return ids.reduce(function(result, id) {
		...
		scale.domain(domain).range(range);
		checkDomainOfScale(scale);
		var ticks = getTicksOfScale(scale, _objectSpread$14(_objectSpread$14({}, axis), {}, { realScaleType }));
		if (axisType === "xAxis") {
		...
		var finalAxis = _objectSpread$14(_objectSpread$14(_objectSpread$14({}, axis), ticks), {}, {
			realScaleType,
			x,
			y,
			scale,
		...
		return _objectSpread$14(_objectSpread$14({}, result), {}, _defineProperty$17({}, id, finalAxis));
	}, {});
};
...
_defineProperty$17(ScaleHelper, "EPS", 1e-4);
var createLabeledScales = function createLabeledScales(options) {
	var scales = Object.keys(options).reduce(function(res, key) {
		return _objectSpread$14(_objectSpread$14({}, res), {}, _defineProperty$17({}, key, ScaleHelper.create(options[key])));
	}, {});
	return _objectSpread$14(_objectSpread$14({}, scales), {}, {
...
function getTicksEnd(sign, boundaries, getTickSize, ticks, minTickGap) {
	...
	var _loop = function _loop(i) {
		...
		if (i === len - 1) {
			...
			result[i] = entry = _objectSpread$13(_objectSpread$13({}, entry), {}, { tickCoord: gap > 0 ? entry.coordinate - gap * sign : entry.coordinate });
		} else result[i] = entry = _objectSpread$13(_objectSpread$13({}, entry), {}, { tickCoord: entry.coordinate });
		if (isVisible(sign, entry.tickCoord, getSize, start, end)) {
			end = entry.tickCoord - sign * (getSize() / 2 + minTickGap);
			result[i] = _objectSpread$13(_objectSpread$13({}, entry), {}, { isShow: true });
		}
	};
...
function getTicksStart(sign, boundaries, getTickSize, ticks, minTickGap, preserveEnd) {
	...
	if (preserveEnd) {
		...
		result[len - 1] = tail = _objectSpread$13(_objectSpread$13({}, tail), {}, { tickCoord: tailGap > 0 ? tail.coordinate - tailGap * sign : tail.coordinate });
...
*/
var _excluded$6 = ["viewBox"], _excluded2$4 = ["viewBox"], _excluded3 = ["ticks"];
...
var CartesianAxis = /*#__PURE__*/ function(_Component) {
	function CartesianAxis(props) {
		var _this;
		_classCallCheck$11(this, CartesianAxis);
		_this = _callSuper$10(this, CartesianAxis, [props]);
		_this.state = {
			fontSize: "",
			letterSpacing: ""
		};
	...
	_inherits$10(CartesianAxis, _Component);
	return _createClass$11(CartesianAxis, [
		{
			key: "shouldComponentUpdate",
			value: function shouldComponentUpdate(_ref, nextState) {
				var viewBox = _ref.viewBox, restProps = _objectWithoutProperties$6(_ref, _excluded$6);
				var _this$props = this.props, viewBoxOld = _this$props.viewBox, restPropsOld = _objectWithoutProperties$6(_this$props, _excluded2$4);
		...
		},
		{
			...
			value: function renderAxisLine() {
				...
				var props = _objectSpread$12(_objectSpread$12(_objectSpread$12({}, filterProps(this.props, false)), filterProps(axisLine, false)), {}, { fill: "none" });
				...
				return /*#__PURE__*/ import_react.createElement("line", _extends$14({}, props, { className: clsx("recharts-cartesian-axis-line", (0, import_get.default)(axisLine, "className")) }));
			}
		},
		{
			key: "renderTicks",
			value: function renderTicks(ticks, fontSize, letterSpacing) {
				...
				var finalTicks = getTicks(_objectSpread$12(_objectSpread$12({}, this.props), {}, { ticks }), fontSize, letterSpacing);
				var textAnchor = this.getTickTextAnchor();
				var verticalAnchor = this.getTickVerticalAnchor();
				var axisProps = filterProps(this.props, false);
				var customTickProps = filterProps(tick, false);
				var tickLineProps = _objectSpread$12(_objectSpread$12({}, axisProps), {}, { fill: "none" }, filterProps(tickLine, false));
				var items = finalTicks.map(function(entry, i) {
					...
					}, adaptEventsOfChild(_this2.props, entry, i)), tickLine && /*#__PURE__*/ import_react.createElement("line", _extends$14({}, tickLineProps, lineCoord, { className: clsx("recharts-cartesian-axis-tick-line", (0, import_get.default)(tickLine, "className")) })), tick && CartesianAxis.renderTickItem(tick, tickProps, "".concat((0, import_isFunction.default)(tickFormatter) ? tickFormatter(entry.value, i) : entry.value).concat(unit || "")));
				});
		...
		},
		{
			...
			value: function render() {
				...
				var _this$props8 = this.props, ticks = _this$props8.ticks, noTicksProps = _objectWithoutProperties$6(_this$props8, _excluded3);
		...
		value: function renderTickItem(option, props, value) {
			...
			if (/*#__PURE__*/ import_react.isValidElement(option)) tickItem = /*#__PURE__*/ import_react.cloneElement(option, _objectSpread$12(_objectSpread$12({}, props), {}, { className: combinedClassName }));
			else if ((0, import_isFunction.default)(option)) tickItem = option(_objectSpread$12(_objectSpread$12({}, props), {}, { className: combinedClassName }));
			else tickItem = /*#__PURE__*/ import_react.createElement(Text, _extends$14({}, props, { className: "recharts-cartesian-axis-tick-value" }), value);
			return tickItem;
		}
	}]);
}(import_react.Component);
_defineProperty$15(CartesianAxis, "displayName", "CartesianAxis");
_defineProperty$15(CartesianAxis, "defaultProps", {
	x: 0,
	y: 0,
	width: 0,
	height: 0,
...
function renderLineItem(option, props) {
	...
	if (/*#__PURE__*/ import_react.isValidElement(option)) lineItem = /*#__PURE__*/ import_react.cloneElement(option, props);
		...
		var x1 = props.x1, y1 = props.y1, x2 = props.x2, y2 = props.y2, key = props.key, _filterProps = filterProps(_objectWithoutProperties$5(props, _excluded$5), false);
		_filterProps.offset;
		var restOfFilteredProps = _objectWithoutProperties$5(_filterProps, _excluded2$3);
		lineItem = /*#__PURE__*/ import_react.createElement("line", _extends$13({}, restOfFilteredProps, {
			x1,
			y1,
			x2,
			y2,
...
function HorizontalGridLines(props) {
	...
	var items = horizontalPoints.map(function(entry, i) {
		return renderLineItem(horizontal, _objectSpread$11(_objectSpread$11({}, props), {}, {
			x1: x,
			y1: entry,
			x2: x + width,
			y2: entry,
...
function VerticalGridLines(props) {
	...
	var items = verticalPoints.map(function(entry, i) {
		return renderLineItem(vertical, _objectSpread$11(_objectSpread$11({}, props), {}, {
			x1: entry,
			y1: y,
			x2: entry,
			y2: y + height,
...
var defaultVerticalCoordinatesGenerator = function defaultVerticalCoordinatesGenerator(_ref, syncWithTicks) {
	...
	return getCoordinatesOfGrid(getTicks(_objectSpread$11(_objectSpread$11(_objectSpread$11({}, CartesianAxis.defaultProps), xAxis), {}, {
...
var defaultHorizontalCoordinatesGenerator = function defaultHorizontalCoordinatesGenerator(_ref2, syncWithTicks) {
	...
	return getCoordinatesOfGrid(getTicks(_objectSpread$11(_objectSpread$11(_objectSpread$11({}, CartesianAxis.defaultProps), yAxis), {}, {
...
function CartesianGrid(props) {
	...
	var propsIncludingDefaults = _objectSpread$11(_objectSpread$11({}, props), {}, {
	...
	if ((!horizontalPoints || !horizontalPoints.length) && (0, import_isFunction.default)(horizontalCoordinatesGenerator)) {
		...
		warn(Array.isArray(generatorResult), "horizontalCoordinatesGenerator should return Array but instead it returned [".concat(_typeof$14(generatorResult), "]"));
	...
	if ((!verticalPoints || !verticalPoints.length) && (0, import_isFunction.default)(verticalCoordinatesGenerator)) {
		...
		warn(Array.isArray(_generatorResult), "verticalCoordinatesGenerator should return Array but instead it returned [".concat(_typeof$14(_generatorResult), "]"));
	...
	}), /*#__PURE__*/ import_react.createElement(HorizontalGridLines, _extends$13({}, propsIncludingDefaults, {
		offset,
		horizontalPoints,
		xAxis,
		yAxis
	})), /*#__PURE__*/ import_react.createElement(VerticalGridLines, _extends$13({}, propsIncludingDefaults, {
		offset,
		verticalPoints,
		xAxis,
		yAxis
	})), /*#__PURE__*/ import_react.createElement(HorizontalStripes, _extends$13({}, propsIncludingDefaults, { horizontalPoints })), /*#__PURE__*/ import_react.createElement(VerticalStripes, _extends$13({}, propsIncludingDefaults, { verticalPoints })));
}
...
var Dot = function Dot(props) {
	...
	if (cx === +cx && cy === +cy && r === +r) return /*#__PURE__*/ import_react.createElement("circle", _extends$12({}, filterProps(props, false), adaptEventHandlers(props), {
		className: layerClass,
		cx,
		cy,
		r
...
var Line = /*#__PURE__*/ function(_PureComponent) {
	function Line() {
		var _this;
		_classCallCheck$10(this, Line);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _callSuper$9(this, Line, [].concat(args));
		_defineProperty$13(_this, "state", {
			isAnimationFinished: true,
			totalLength: 0
		});
		_defineProperty$13(_this, "generateSimpleStrokeDasharray", function(totalLength, length) {
			return "".concat(length, "px ").concat(totalLength - length, "px");
		});
		_defineProperty$13(_this, "getStrokeDasharray", function(length, totalLength, lines) {
		...
		_defineProperty$13(_this, "id", uniqueId("recharts-line-"));
		_defineProperty$13(_this, "pathRef", function(node) {
	...
	_inherits$9(Line, _PureComponent);
	return _createClass$10(Line, [
		{
			key: "componentDidMount",
			value: function componentDidMount() {
		...
		},
		{
			...
			value: function renderCurveStatically(points, needClip, clipPathId, props) {
				...
				_this$props3.ref;
				var curveProps = _objectSpread$10(_objectSpread$10(_objectSpread$10({}, filterProps(_objectWithoutProperties$4(_this$props3, _excluded$4), true)), {}, {
					fill: "none",
				...
				return /*#__PURE__*/ import_react.createElement(Curve, _extends$11({}, curveProps, { pathRef: this.pathRef }));
			}
		},
		{
		...
		},
		{
			...
			value: function repeat(lines, count) {
				...
				var result = [];
				for (var i = 0; i < count; ++i) result = [].concat(_toConsumableArray$3(result), _toConsumableArray$3(linesUnit));
				return result;
			}
		},
		{
			...
			value: function renderDotItem(option, props) {
				...
				if (/*#__PURE__*/ import_react.isValidElement(option)) dotItem = /*#__PURE__*/ import_react.cloneElement(option, props);
					...
					var key = props.key, dotProps = _objectWithoutProperties$4(props, _excluded2$2);
					var className = clsx("recharts-line-dot", typeof option !== "boolean" ? option.className : "");
					dotItem = /*#__PURE__*/ import_react.createElement(Dot, _extends$11({ key }, dotProps, { className }));
				}
				return dotItem;
			}
		}
...
_defineProperty$13(Line, "displayName", "Line");
_defineProperty$13(Line, "defaultProps", {
	xAxisId: 0,
	yAxisId: 0,
	connectNulls: false,
	activeDot: true,
...
* @return {Array}  Composed data
*/
_defineProperty$13(Line, "getComposedData", function(_ref4) {
...
function XAxisImpl(_ref) {
	...
	return /*#__PURE__*/ import_react.createElement(CartesianAxis, _extends$10({}, axisOptions, {
...
var XAxis = /*#__PURE__*/ function(_React$Component) {
	function XAxis() {
		_classCallCheck$9(this, XAxis);
		return _callSuper$8(this, XAxis, arguments);
	}
	_inherits$8(XAxis, _React$Component);
	return _createClass$9(XAxis, [{
		key: "render",
		value: function render() {
...
_defineProperty$12(XAxis, "displayName", "XAxis");
_defineProperty$12(XAxis, "defaultProps", {
	allowDecimals: true,
	hide: false,
	orientation: "bottom",
	width: 0,
...
var YAxisImpl = function YAxisImpl(_ref) {
	...
	if (axisOptions == null) return null;
	return /*#__PURE__*/ import_react.createElement(CartesianAxis, _extends$9({}, axisOptions, {
		className: clsx("recharts-".concat(axisOptions.axisType, " ").concat(axisOptions.axisType), axisOptions.className),
		viewBox: {
			x: 0,
			y: 0,
...
var YAxis = /*#__PURE__*/ function(_React$Component) {
	function YAxis() {
		_classCallCheck$8(this, YAxis);
		return _callSuper$7(this, YAxis, arguments);
	}
	_inherits$7(YAxis, _React$Component);
	return _createClass$8(YAxis, [{
		key: "render",
		value: function render() {
...
_defineProperty$11(YAxis, "displayName", "YAxis");
_defineProperty$11(YAxis, "defaultProps", {
	allowDuplicatedCategory: true,
	allowDecimals: true,
	hide: false,
	orientation: "left",
...
var generatePrefixStyle = function generatePrefixStyle(name, value) {
	...
	var result = PREFIX_LIST.reduce(function(res, entry) {
		return _objectSpread$9(_objectSpread$9({}, res), {}, _defineProperty$10({}, entry + camelName, value));
	}, {});
	result[name] = value;
	return result;
};
...
var Brush = /*#__PURE__*/ function(_PureComponent) {
	function Brush(props) {
		...
		_defineProperty$9(_this, "handleDrag", function(e) {
			if (_this.leaveTimer) {
		...
		_defineProperty$9(_this, "handleTouchMove", function(e) {
			if (e.changedTouches != null && e.changedTouches.length > 0) _this.handleDrag(e.changedTouches[0]);
		});
		_defineProperty$9(_this, "handleDragEnd", function() {
			_this.setState({
				isTravellerMoving: false,
				isSlideMoving: false
			}, function() {
		...
		_defineProperty$9(_this, "handleLeaveWrapper", function() {
		...
		_defineProperty$9(_this, "handleEnterSlideOrTraveller", function() {
			_this.setState({ isTextActive: true });
		});
		_defineProperty$9(_this, "handleLeaveSlideOrTraveller", function() {
			_this.setState({ isTextActive: false });
		});
		_defineProperty$9(_this, "handleSlideDragStart", function(e) {
	...
	return _createClass$7(Brush, [
		...
		},
		{
			...
			value: function handleTravellerMove(e) {
				...
				this.setState(_defineProperty$9(_defineProperty$9({}, movingTravellerId, prevValue + delta), "brushMoveStartX", e.pageX), function() {
					if (onChange) {
		...
		},
		{
			...
			value: function handleTravellerMoveKeyboard(direction, id) {
				...
				this.setState(_defineProperty$9({}, id, newScaleValue), function() {
		...
		},
		{
			...
			value: function renderTravellerLayer(travellerX, id) {
				...
				var travellerProps = _objectSpread$8(_objectSpread$8({}, filterProps(this.props, false)), {}, {
					x,
					y,
		...
		},
		{
			...
			value: function getDerivedStateFromProps(nextProps, prevState) {
				...
				if (data !== prevState.prevData || updateId !== prevState.prevUpdateId) return _objectSpread$8({
					prevData: data,
...
_defineProperty$9(Brush, "displayName", "Brush");
_defineProperty$9(Brush, "defaultProps", {
	height: 40,
	travellerWidth: 5,
	gap: 1,
	fill: "#fff",
...
//#endregion
export { XAxis as a, Bar as c, ResponsiveContainer as d, Tooltip as f, YAxis as i, Pie as l, BarChart as n, Line as o, LineChart as r, CartesianGrid as s, PieChart as t, Cell as u };
